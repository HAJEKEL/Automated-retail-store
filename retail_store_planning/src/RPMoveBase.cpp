...
namespace KCL_rosplan {
	...
	/*
		The below code is gathered from viewing the 'msg' and assigning the information to variables in order to achieve the goal position
	*/
        ...
        if(ac.getState() == actionlib::SimpleClientGoalState::SUCCEEDED)
            ...
            ROS_INFO("The base failed to move backward 1 meter for some reason");
